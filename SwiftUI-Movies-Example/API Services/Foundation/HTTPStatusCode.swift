...
enum HTTPStatusCode: Int, Codable, Error {
   
   /// The response class representation of status codes, these get grouped by their first digit.
   enum ResponseType {
      
      /// A provisional response, consisting only of the Status-Line and optional headers, and is
      /// terminated by an empty line.
      case informational
      
      /// The action requested by the client was received, understood, accepted, and processed
      /// successfully.
      case success
      ...
      /// The status code cannot be resolved.
      case undefined
   }
   ...
   /// A request method is not supported for the requested resource. e.g. a GET request on a form
